<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ADashboard.aspx.cs" Inherits="HotelDemo.ADashboard" %>
                        ...
                        <div id="profile-page-header" class="card">
                            ...
                            <div class="card-content">
                                <div class="row">
                                    ...
                                    <div class="col s2 center-right">
                                        <h4 class="card-title grey-text text-darken-4">Login Student</h4>
                                        <p class="medium-small grey-text">
                                            <asp:Label runat="server" ClientIDMode="Static" ID="lblCount"></asp:Label>
                                        </p>
                                    </div>
